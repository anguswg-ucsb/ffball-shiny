...
selectInput("variableDropdown",
            label = "Variable", 
            choices = c(NULL, "Air yards","Yards after catch", "Touches", "Targets/Receptions", "Yards per touch"))
...
#     df2 <- headshotData()
#     pic <- df2
#     tags$img(src = pic, width = 200, height = 100)
#    }
# })
...
leagueRankData <- eventReactive(input$submitButton, {
  if(input$variableDropdown == "Air yards") {
        ...
        highchart() %>%
          ...
          hc_chart(plotBorderWidth = 1, plotBorderColor = '#b4b4b4', height = NULL) %>%
          hc_xAxis(categories = rank_airyards$full_name) 
 ...
 # round values to 2 decimals
      ...
      highchart() %>% 
          ...
          hc_xAxis(categories = rank_ypc$full_name) %>% 
          hc_chart(plotBorderWidth = 1, plotBorderColor = '#b4b4b4', height = NULL)
